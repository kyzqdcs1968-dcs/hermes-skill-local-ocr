...
| **OCR + 脱敏** | `~/.hermes/skills/productivity/local-wechat-ocr/scripts/run_mac_ocr.sh --anonymize "/绝对路径/材料.pdf"` |
| **脱敏（指定模型）** | `~/.hermes/skills/productivity/local-wechat-ocr/scripts/run_mac_ocr.sh --anonymize --anonymize-model qwen2.5:7b "/绝对路径/材料.pdf"` |
| **脱敏 + 去页码** | `~/.hermes/skills/productivity/local-wechat-ocr/scripts/run_mac_ocr.sh --anonymize --anonymize-model deepseek-r1:32b --merge-pages "/绝对路径/材料.pdf"` |
| 仅去页码 | `~/.hermes/skills/productivity/local-wechat-ocr/scripts/run_mac_ocr.sh --merge-pages "/绝对路径/材料.pdf"` |
| 预检（含脱敏参数） | `~/.hermes/skills/productivity/local-wechat-ocr/scripts/run_mac_ocr.sh --anonymize --merge-pages --dry-run "/绝对路径/材料.pdf"` |
...
4. 脚本会在 `~/.hermes/cache/local-wechat-ocr/jobs/` 创建隔离作业目录，将输入复制到其中。不得直接修改源文件。
